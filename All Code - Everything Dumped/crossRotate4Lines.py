...
#differenceImages[0] = np.clip(image, 110, 150)
#differenceImages[0] = (differenceImages[0]-np.nanmin(differenceImages[0]))/(np.nanmax(differenceImages[0])-np.nanmin(differenceImages[0]))
#differenceImages[0] = differenceImages[0] * 255
