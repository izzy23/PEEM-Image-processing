...
#uncomment if rotation issues - use to plot and fix
#plt.axis("off")
...
#img2 = differenceImages[1]

#fig1 = ax1.imshow(img1, cmap="gray", vmin = -0.1, vmax = 0.1)
#fig2 = ax2.imshow(img2, cmap="gray", vmin = -0.1, vmax = 0.1)
...
#defines slider axis
#axs2 = plt.axes([0.15, 0.01, 0.65, 0.03])
#sl2 = Slider(axs2, 'rotation angle', -180, 180, valinit=0, valstep = 15)
...
#    print("current rotation angle = " + str(angles[sb.val]))
...
#    angles[sb.val] = int(sl2.val)

#    differenceImages[sb.val] = rotateImg(differenceImages[sb.val], angles[sb.val])
