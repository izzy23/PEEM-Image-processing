...
for i in range(1, len(differenceImages)):
    ...
    #       kp1, des1 = sift.detectAndCompute(img1,None)    USE THESE !!!!!!
    ...
    #des2 = np.array([], dtype = np.float32)
    des1 = cv2.goodFeaturesToTrack(img1, 500, qualityLevel=0.01, minDistance=30, blockSize=3)
    des2, st, err = cv2.calcOpticalFlowPyrLK(img1, img2, des1, None, maxLevel=1)
