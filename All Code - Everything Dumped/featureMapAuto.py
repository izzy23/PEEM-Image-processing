...
def driftCorrect(imgArr):
    ...
    for i in range(0, len(imgArr)-1):
        ...
        #print("no of points before = " + str(len(prev_pts)))
        #print("no of points now = " + str(len(curr_pts)))
...
#differenceImages = [io.imread(r"writeImages\321457_D_avg.tif").astype(np.float32)]
#intensityImages = [io.imread(r"writeImages\321457_I_avg.tif").astype(np.float32)]
