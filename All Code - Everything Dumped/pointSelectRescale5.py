...
for i in range(0, len(differenceImages)):
    ...
    for x in range(0, 4):
        ...
        print("hopefully first x")
        print(sorted_contours[0][0][0, 0])
        print("hopefully first y")
        print(sorted_contours[0][0][0, 1])
        linePoints = []
        #linePoints = [(sorted_contours[0][0][0, 0], sorted_contours[0][0][0, 1])]
        ...
        #    turningPoints = turningPoints + [turningPointsX, turningPointsY]
        for j in range(0, len(turningPointsX)):
            x = turningPointsX[j]
            y = turningPointsY[j]
            turningPoints = turningPoints + [[x, y]]
        #sorted_contours[0] = turningPoints
        ...
        if i == 0:
            ...
            #code that snapped to contour - replaced with corners
